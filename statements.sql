...
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes WHERE lenguaje = '' OR lenguaje IS NULL;
...
-- Tu respuesta aquí
SELECT nombre, edad FROM usuarios_lenguajes ORDER BY edad ASC
...
-- Tu respuesta aquí
SELECT lenguaje AS lenguaje_popular, COUNT(*) AS total_usuarios
...
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes WHERE (edad > 25 OR edad < 35) AND lenguaje IS NOT NULL;
...
-- Tu respuesta aquí
SELECT edad, COUNT(*) AS total_usuarios
FROM usuarios_lenguajes
GROUP BY edad;
...
SELECT *
FROM usuarios_lenguajes
WHERE lenguaje LIKE 'J%' AND LENGTH(lenguaje) = 4;
...
-- Tu respuesta aquí
SELECT COUNT(*) FROM usuarios_lenguajes WHERE (edad > 20 OR edad < 25) AND lenguaje IS NOT NULL;
...
-- Tu respuesta aquí
SELECT lenguaje FROM usuarios_lenguajes WHERE age > 29 ORDER BY LENGTH(lenguaje) ASC LIMIT 1;
